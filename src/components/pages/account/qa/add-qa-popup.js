...
export class CustomElement extends LitElement {
    ...
    _handleSubmit() {
        ...
        // Optionally, clear the form or close the modal here or in the parent
    }
        ...
        return html`
            ...
            <div class="modal-contents">
                <div class="form-group">
                    <label for="questionText" class="section-label">Your Question:</label>
                    <custom-input
                            id="questionText"
                ...
                <div class="checkbox-group">
                    ...
                    />
                    <label for="anonymousCheck">Ask Anonymously</label>
                </div>
